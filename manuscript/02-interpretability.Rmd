...
フェイスブックのデータを元に、友人が次の休日にどこへ行くのかを機械学習で予測するサイドプロジェクトに取り組んでいるマイクという人物を思い浮かべてください。
...
高い正確性は、機械学習のモデルの代わりに説明自体が予測のために用いられる場合に特に重要です。ただし、モデルの精度自体がそれほど高くない場合や、ブラックボックスモデルを説明することが目的である場合、正確性はそれほど重要ではありません。
...
- **代表性 (Representativeness)**：説明はどれほどのインスタンスをカバーしているか？
